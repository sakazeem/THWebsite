    ...
    <div class="row">
        ...
        <div class="placeBlock">
                        ...
                        <div class="dBoxTxt" onclick="window.open('/guides-detail.php','_self')">
                            ...
                            <h6>Guide: Where to eat in Dubai when money's too tight to mention</h6>
                            <p>Discover where you can get 10AED epic noodles, 30AED for 3 pretty-as-a-picture sush...</p>
        ...
        <div class="placeBlock">
                        ...
                        <img src="./images/place3.png" class="img-fluid" alt="">
                        <div class="dBoxTxt" onclick="window.open('/guides-detail.php', '_self')">
                            <p class="category-title">FREE ACCESS<span class="dot"></span>NEWS<span class="dot"></span>GUIDES</p>
                            <h6>Guide: All of the places you have special perks at, dear HUNTR member.</h6>
                            <p>"I'm a HUNTR member" these four little words not only make you pretty cool and smart...</p>
