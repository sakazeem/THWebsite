...
<section class="inner-banner">
  <div class="container-fluid">    
    <div class="row top-banner">
        ...
        <div class="inner-banner-text-bottom"> 
            <div class="smallHD"><img src="images/huntr-icon.png" class="icon-huntr" />The Huntr's guide to</div>
             <h3>The places we can't stop thinking about right now...</h3>
            <div class="placeUsr">
